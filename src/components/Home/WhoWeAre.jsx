  ...
  return (
    <div className='Container__Parent'>
      ...
      <div className='Container__Digital'>
          ...
          <h2>Unique Business Consulting <br/><span className='Digital__Span'> Agency</span> corporate.</h2>
        ...
        <ul>
          <li><IoIosArrowDropright className='Lists__Icon'/>Branding the latest marketing agency.</li>
          <li><IoIosArrowDropright className='Lists__Icon'/>Connect to more online customers.</li>
          <li><IoIosArrowDropright className='Lists__Icon'/>Grow up your digital business.</li>
          </ul>
          <button className='Digital__Button'>Discover More <FaRegArrowAltCircleRight/></button>
      </div>
...
<div className='Main__Icon'>
        ...
        <div className='Annual__Content'>
          <h3>ANNUAL</h3>
          <p>87%</p>
          <article className='Progress__Bar'><progress value={0.9} label={45} />
</article>
